...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (!response.ok) {
            console.error('Velana PIX error', {
        ...
        // Velana API typical response structure:
        // { id, status, pix: { qrcode: "...", url: "..." }, ... }
        const pix = data.pix || {};
        ...
        return res.status(500).json({ message: 'Erro interno ao comunicar com o Gateway Velana', error: error.message });
    }
}
